...
{
    /**
     * test_info:character、picture_char、tof
     * @param $test_info
     * @return bool|CI_DB_active_record|CI_DB_result
     */
    public function insert_new_test($test_info){
        if(isset($test_info['character'])&&isset($test_info['picture_char'])&&isset($test_info['tof'])){
            ...
            if($relation_char!=null&&$picture_char!=null){
                ...
                $data['character']=$relation_char['character'];
